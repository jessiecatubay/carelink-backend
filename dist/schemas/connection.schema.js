...
import { z } from "zod";
export const connectSchema = requestSchema(z
    .object({
...
export const updateConnectionSchema = requestSchema(z
    .object({
    ...
    .strict()
    .refine((data) => data.status !== undefined || data.currentPatient !== undefined, { message: "status or currentPatient is required" }));
export const patientProfileSchema = requestSchema(z
    .object({
    patientId: uuidSchema,
    ...
    .strict());
export const generateConnectionCodeSchema = requestSchema(z.object({ id: uuidSchema }).strict());
